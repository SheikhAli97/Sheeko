        ...
        <div className="icon-wrapper">
          <div className="icon-inner-wrapper">
            <div className="icon-top">
              <div>
                <span
                  ><a href="#"><i className="ri-checkbox-blank-fill"></i></a
                ></span>
              </div>
              <div>
                <span
                  ><a href="#"><i className="ri-function-line"></i></a
                ></span>
                <span
                  ><a href="#"><i className="ri-battery-charge-line"></i></a
                ></span>
                <span
                  ><a href="#"><i className="ri-calendar-2-line"></i></a
                ></span>
                <span
                  ><a href="#"><i className="ri-chat-3-fill"></i></a
                ></span>
                <span
                  ><a href="#"><i className="ri-group-line"></i></a
                ></span>
              </div>
            </div>
            <div className="icon-bottom">
              <div>
                <span
                  ><a href="#"><i className="ri-notification-3-line"></i></a
                ></span>
                <span
                  ><a href="#"><i className="ri-settings-2-line"></i></a
                ></span>
              </div>
                        ...
                        <div className="chat-details">
                          <div className="chat-details-left">
                            ...
                            <div className="chat-name">
                              ...
                              <span className="read-message">Wow, really cool</span>
                            </div>
                          </div>
                          <div className="chat-details-right">
                            <div className="chat-time">
          ...
          <div className="chat-inner-wrapper">
            <div className="chat-top">
              ...
              <div className="chat-top-icon">
                <span><i className="ri-vidicon-line"></i></span>
                <span><i className="ri-phone-line"></i></span>
                <span><i className="ri-outlet-line"></i></span>
              </div>
            </div>
                    ...
                    <ul>
                      <li>
                        <div className="message-body">
                          ...
                          <div className="message-text">
                            <h4>Design Team<span>&nbsp&nbsp9:12 AM</span></h4>
                      ...
                      <li>
                        <div className="message-body">
                          ...
                          <div className="message-text">
                            <h4>Design Team<span>&nbsp&nbsp9:14 AM</span></h4>
                  ...
                  <div className="chat-middle-right">
                    <ul>
                      <li>
                        <div className="message-body">
                          <div className="message-text">
                            <h4><span>9:30 AM&nbsp&nbsp</span>You</h4>
                            <p>Ok, Thanks</p>
                          </div>
                          <div className="message-image">
            ...
            <div className="chat-bottom">
              <form action="" id="sendMessage">
                ...
                <div className="send-message-icons">
                  <a href="#"><i className="ri-mic-line"></i></a>
                  <a href="#"><i className="ri-attachment-2"></i></a>
        ...
        <div id="scroll-bar-style" className="chat-info-wrapper">
          <div className="chat-info-inner-wrapper">
            <div className="chat-info-title">
              <span>Design Team</span>
              <span
                ><a href="#"><i className="ri-close-fill"></i></a
              ></span>
            </div>
            ...
            <div className="media">
              <div className="chat-info-sub-title-wrapper show-btn">
                <div className="chat-info-sub-title">
                  <span><i className="ri-image-fill"></i></span>
                  <span>MEDIA (29)</span>
                </div>
                <div className="show-all-btn">
                  <a href="#">Show All</a>
            ...
            <div className="file-type">
              <div className="chat-info-sub-title-wrapper">
                <div className="chat-info-sub-title">
                  <span><i className="ri-folder-reduce-fill"></i></span>
              ...
              <div className="file-type-wrapper">
                <div className="file-type-inner-wrapper">
                  <div className="file-type-text">
                    <span><i className="ri-file-3-fill"></i></span>
                    <span>
                      <h4>Documents</h4>
                      <p>126 files</p>
                    </span>
